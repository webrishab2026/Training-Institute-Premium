// app/rishab-retail/page.tsx - FIXED VERSION
'use client';
...
const products = [
  ...
  { 
    ...
    tags: ['Limited Stock', 'Sports']
  },
];

// Hero slides with real retail images
const heroSlides = [
  {
    id: 1,
    title: 'Diwali Special Sale',
    subtitle: 'Upto 50% off on Electronics & Home Appliances',
  ...
  },
  {
    ...
    subtitle: 'No shipping charges on orders above ₹999',
      ...
      <header className="sticky top-0 z-50 bg-white shadow-md border-b">
        <div className="container mx-auto px-4">
          ...
          <nav className="hidden md:flex items-center gap-8 py-3 border-t">
            <Link href="/electronics" className="text-gray-700 hover:text-blue-600 font-medium">Electronics</Link>
            <Link href="/fashion" className="text-gray-700 hover:text-blue-600 font-medium">Fashion</Link>
            <Link href="/home" className="text-gray-700 hover:text-blue-600 font-medium">Home & Kitchen</Link>
            <Link href="/beauty" className="text-gray-700 hover:text-blue-600 font-medium">Beauty</Link>
            <Link href="/sports" className="text-gray-700 hover:text-blue-600 font-medium">Sports</Link>
            <Link href="/deals" className="text-red-600 hover:text-red-700 font-medium">Today's Deals</Link>
            <Link href="/new" className="text-green-600 hover:text-green-700 font-medium">New Arrivals</Link>
          </nav>
        </div>
            ...
            <div className="container mx-auto px-4 py-4">
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Link href="/electronics" className="p-3 bg-gray-50 rounded-lg">Electronics</Link>
                  <Link href="/fashion" className="p-3 bg-gray-50 rounded-lg">Fashion</Link>
                  <Link href="/home" className="p-3 bg-gray-50 rounded-lg">Home</Link>
                  <Link href="/deals" className="p-3 bg-red-50 text-red-600 rounded-lg">Deals</Link>
                </div>
                <div className="pt-4 border-t">
                  ...
                  <Link href="/cart" className="flex items-center gap-3 p-3">Cart</Link>
                  <Link href="/industry-connect/snowflake-connect" className="flex items-center gap-3 p-3 bg-blue-50 text-blue-700 rounded-lg mt-2">
                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z"></path>
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                    </svg>
        ...
        <section className="py-12 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
              {['Electronics', 'Fashion', 'Home & Kitchen', 'Beauty', 'Sports', 'Books'].map((cat, idx) => (
                <Link 
                  key={cat} 
                  href={`/${cat.toLowerCase().replace(/ & /g, '-').replace(/ /g, '-')}`}
                  className="bg-white rounded-xl p-6 text-center shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1"
                >
                  <div className={`w-16 h-16 rounded-full mx-auto mb-4 flex items-center justify-center ${
                    ...
                    idx === 2 ? 'bg-green-100' :
                    idx === 3 ? 'bg-purple-100' :
                    idx === 4 ? 'bg-orange-100' : 'bg-yellow-100'
                  }`}>
                    <Package className={`w-8 h-8 ${
                      ...
                      idx === 4 ? 'text-orange-600' : 'text-yellow-600'
                    }`} />
                  </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex justify-between items-center mb-10">
              <div>
                ...
                <p className="text-gray-600">Real-time stock from across our 42 stores</p>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
            <div>
              ...
              <p className="text-gray-400">
                Multi-store retail experience with real-time inventory synchronization across 42 locations nationwide.
              </p>
            </div>
          ...
          <div className="pt-8 border-t border-gray-800 text-center">
            <p className="text-gray-500 text-sm">
              ⚠️ <strong>Demo Notice:</strong> Rishab Retail is a fictional brand created for demonstrating real-time inventory synchronization technology.
            </p>
