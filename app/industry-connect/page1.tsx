...
const GOOGLE_FORM_URL = "[https://forms.gle/PFat1nZEUnwWW8y89](https://forms.gle/PFat1nZEUnwWW8y89)";
          ...
          <Paper elevation={3} sx={{ p: 4, height: '100%', borderRadius: 2, display: 'flex', flexDirection: 'column' }}>
            ...
            <List dense>
              <ListItem>
                ...
                <ListItemText primary="Get expert guidance on complex IT tasks." />
              </ListItem>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Improve your real-time project performance." />
              </ListItem>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Gain confidence in your role." />
              </ListItem>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Receive practical, hands-on solutions." />
              </ListItem>
            </List>
            <Box sx={{ mt: 'auto', pt: 2 }}>
        ...
        <Grid item xs={12} md={6}>
          <Paper elevation={3} sx={{ p: 4, height: '100%', borderRadius: 2, display: 'flex', flexDirection: 'column' }}>
            ...
            <List dense>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Utilize your expertise to help others succeed." />
              </ListItem>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Earn supplementary income on a flexible schedule." />
              </ListItem>
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
              ...
              <ListItem>
                <ListItemIcon sx={{ minWidth: '36px' }}><CheckCircle color="success" /></ListItemIcon>
                <ListItemText primary="Contribute to the IT community." />
              </ListItem>
            </List>
            <Box sx={{ mt: 'auto', pt: 2 }}>
                <Typography variant="body2" color="text.secondary">
      ...
      <Paper elevation={3} sx={{ bgcolor: 'info.main', color: 'white', p: 4, textAlign: 'center', borderRadius: 2 }}>
        ...
        <List sx={{ display: 'flex', flexDirection: { xs: 'column', sm: 'row' }, justifyContent: 'center', gap: 2, p: 0 }}>
          <ListItem disablePadding sx={{ width: { xs: '100%', sm: 'auto' }, justifyContent: 'center' }}>
            <Button
              variant="contained"
              sx={{ bgcolor: 'white', color: 'info.main', '&:hover': { bgcolor: 'grey.200' }, borderRadius: 4, px: 3, py: 1.5 }}
